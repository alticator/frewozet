...
KERNEL_SRC    = kernel.c terminal.c idt.c pic.c keyboard.c shell.c calc.c utils.c
...
$(KERNEL_ELF): $(ENTRY_OBJ) $(ISR_IRQ_OBJ) $(KERNEL_OBJS) $(LINKER_SRC)
	$(LD) $(LDFLAGS) -o $(KERNEL_ELF) $(ENTRY_OBJ) $(ISR_IRQ_OBJ) $(KERNEL_OBJS)
